    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="glass rounded-3xl p-12 md:p-16">
        <div className="max-w-2xl">
          <h2 className="text-3xl md:text-4xl font-bold text-primary dark:text-secondary mb-4">Stay Updated</h2>
          <p className="text-muted-foreground mb-8">
            Get exclusive access to new blends, limited editions, and brewing tips delivered to your inbox.
          </p>
