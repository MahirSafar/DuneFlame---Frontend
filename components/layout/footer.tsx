...
export default function Footer() {
  ...
  return (
    <footer className="bg-espresso-brown dark:bg-espresso-brown text-dune-paper dark:text-dune-paper border-t border-dune-paper/20" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-2">
              <Link href="/" className="inline-block group">
                <h3 className="font-bold text-2xl mb-4 group-hover:opacity-80 transition-opacity">
                  DuneFlame
                </h3>
              </Link>
                  ...
                  {socialLinks.map((social) => {
                    ...
                    return (
                      <a
                        ...
                        className="w-10 h-10 flex items-center justify-center rounded-full bg-dune-paper/10 hover:bg-dune-paper/20 transition-all duration-300 hover:scale-110"
              ...
              <ul className="space-y-3">
                {footerLinks.company.map((link) => (
                  <li key={link.href}>
                    <Link 
                      href={link.href} 
                      className="text-sm opacity-90 hover:opacity-100 hover:translate-x-1 inline-block transition-all duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="border-t border-dune-paper/20 py-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            {/* Language Selector - Left */}
            <div className="order-2 lg:order-1">
              <div className="[&_[data-slot=button]]:!bg-[#2B1B13] [&_[data-slot=button]]:!text-[#FBEDDC] [&_[data-slot=button]]:!border-dune-taupe dark:[&_[data-slot=button]]:!bg-[#2B1B13] dark:[&_[data-slot=button]]:!text-[#FBEDDC] dark:[&_[data-slot=button]]:!border-dune-taupe">
                <LanguageSwitcher />
              </div>
            </div>
            ...
            <ul className="list-payment flex flex-wrap items-center justify-center lg:justify-end gap-2 order-3" role="list">
